...
*/
export async function prismaUnifier(test_mocha = 0) {
    //checkJSON();
    //genSubschemasPath();
    ...
    if (!test_mocha)
        console.log('🎯', colorLogs.Bright, 'Unified Schema Ready at : ', colorLogs.Reset, colorLogs.FgBlue, mainSchemaPrismaPath, colorLogs.Reset, '\n');
